...
//					System.out.println((int)c1-'A'+1);
		...
		for (int i = 0; i < POI.length; i++) {
			for (int j = 0; j < count.length; j++) {
				if (POI[i] == count[j]) {
//					System.out.println( j+1 + " " +(char)(j+'A'));
					res = res.concat((char)(j+ 'A') +"");
				}
			}
		}
		return res;
